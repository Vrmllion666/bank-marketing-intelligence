...
if page == "Home":
    ...
    for col, (judul, deskripsi) in zip(cols_fitur, fitur):
      with col:
        ...
        <div style='background:rgba(128,128,128,0.07);border:1px solid rgba(128,128,128,0.15);
                    border-radius:12px;padding:20px;text-align:center;min-height:110px;'>
    ...
    members = [
        ...
        ("Agril Adirizky", "NIM: 24051214095","https://raw.githubusercontent.com/Vrmllion666/bank-marketing-intelligence/main/image/agr.jpg"),
    ]
