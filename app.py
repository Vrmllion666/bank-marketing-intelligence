...
with st.sidebar:
    ...
    <b>Model Aktif:</b> {meta['best_model_name']}<br>
    <b>ROC-AUC:</b> {meta['xgb_metrics']['ROC-AUC']}<br>
    <b>Accuracy:</b> {meta['xgb_metrics']['Accuracy']}<br>
    <b>Fitur:</b> {meta['n_features']}<br>
    <b>Cluster:</b> {meta['n_clusters']}
    </div>
    """, unsafe_allow_html=True)
